...
(function () {
  ...
  const dict = {
    en: {
      'meta.title': 'LAP Landscaping — Custom Landscaping & Hardscape Solutions for Beautiful Outdoor Living',
      'meta.desc': 'Custom landscaping & hardscape solutions for outdoor living. Paver patios, irrigation, sod, lighting, drainage. Bilingual. Licensed & insured. Free estimates.',
      ...
      'hero.pill': 'PREMIUM LANDSCAPING. BUILT TO LAST.',
      'hero.region': 'Proudly Serving Lake Norman & Surrounding Communities',
      ...
      'projects.p': 'A peek at recent paver patios, retaining walls, sod restorations and lighting installs. Real LAP project photography will replace temporary imagery once delivered.',
      ...
      'ftr.sms': 'SMS Terms',
      'hero.title': 'Custom Landscaping & Hardscape Solutions for <em>Beautiful Outdoor Living</em>',
      'hero.lede': 'Outdoor spaces built for the way you live — crafted with precision, premium materials, and a commitment to excellence.',
      ...
      'pg.lede': 'Real stages of an LAP build — site walk, plan, install, hand-off.',
      'pg.s1.h': 'Site walk',
      ...
      'about.p': "We're a small, family-run crew based in Troutman that takes hardscape and landscape work seriously. The same team walks your property, designs the plan, and builds the finished space — so quality stays high and surprises stay low.",
      ...
      'reviews.title': 'Trusted by Homeowners Who Wanted It Done Right',
      'reviews.meta': 'Based on placeholder reviews · real reviews required before launch',
      'reviews.lede': 'Prototype placeholder testimonials shown — real customer reviews are required before launch.',
      'rev1.q': '"They handled grading, drainage and a full paver patio in one shot — finished on time, cleaned up daily, and the patio looks perfect a year later."',
      'rev1.n': 'Placeholder — Recent Patio Client', 'rev1.t': 'Paver patio & drainage',
      'rev2.q': '"Smart, zoned irrigation and fresh sod across the whole property. Lawn looks like a magazine and our water bill went down."',
      'rev2.n': 'Placeholder — Recent Lawn Client', 'rev2.t': 'Irrigation & sod',
      'rev3.q': '"Walked us through every option without pressure. The retaining wall solved our slope problem and the lighting changed how we use the yard at night."',
      'rev3.n': 'Placeholder — Recent Hardscape Client', 'rev3.t': 'Retaining wall & lighting',
      'faq.eyebrow': 'FAQ',
      ...
      'cta.step1.p': 'A real LAP crew member visits, listens to how you want to use the space and takes measurements.',
      ...
      'ftr.flag': 'Prototype build — not for production deployment.',
      'sticky.call': 'Call',
    ...
    es: {
      'meta.title': 'LAP Landscaping — Soluciones Premium de Jardinería y Hardscape para una Vida Exterior Hermosa',
      'meta.desc': 'Soluciones a medida de jardinería y hardscape para vida exterior. Patios de adoquines, riego, césped, iluminación, drenaje. Bilingüe. Con licencia y seguro. Presupuestos gratis.',
      ...
      'hero.pill': 'JARDINERÍA PREMIUM. HECHA PARA DURAR.',
      'hero.region': 'Atendemos con Orgullo Lake Norman y Comunidades Cercanas',
      ...
      'projects.p': 'Un vistazo a patios, muros, restauraciones de césped e iluminación recientes. Las fotos reales de proyectos LAP reemplazarán las imágenes temporales cuando se entreguen.',
      ...
      'hero.title': 'Soluciones a Medida de Jardinería y Hardscape para una <em>Vida Exterior Hermosa</em>',
      'hero.lede': 'Espacios exteriores diseñados para su forma de vivir — construidos con precisión, materiales premium y compromiso con la excelencia.',
      'hero.bilingual': '🌎 Se habla Español | We speak English & Spanish',
      ...
      'pg.lede': 'Etapas reales de un proyecto LAP — visita, plan, instalación y entrega.',
      ...
      'services.lede': 'Seis servicios. Un solo equipo. El mismo equipo recorre su propiedad, dibuja el plan y construye el resultado.',
      'svc.link': 'Ver más →',
      ...
      'about.p': 'Somos un equipo familiar pequeño, basado en Troutman, que toma en serio el trabajo de hardscape y jardinería. El mismo equipo recorre su propiedad, diseña el plan y construye el espacio terminado — para que la calidad se mantenga alta y las sorpresas bajas.',
      ...
      'reviews.title': 'Confianza de los Dueños de Casa que Querían un Trabajo Bien Hecho',
      'reviews.meta': 'Basado en testimonios de muestra · se requieren reseñas reales antes del lanzamiento',
      'reviews.lede': 'Testimonios de muestra del prototipo — se requieren reseñas reales antes del lanzamiento.',
      'rev1.q': '"Manejaron nivelación, drenaje y un patio completo de adoquines de una sola vez — terminaron a tiempo, limpiaron todos los días, y el patio se ve perfecto un año después."',
      'rev1.n': 'Muestra — Cliente Reciente de Patio', 'rev1.t': 'Patio de adoquines y drenaje',
      'rev2.q': '"Riego inteligente por zonas y césped fresco en toda la propiedad. El césped parece de revista y la factura de agua bajó."',
      'rev2.n': 'Muestra — Cliente Reciente de Césped', 'rev2.t': 'Riego y césped',
      'rev3.q': '"Nos explicaron cada opción sin presión. El muro resolvió el problema de la pendiente y la iluminación cambió cómo usamos el patio de noche."',
      'rev3.n': 'Muestra — Cliente Reciente de Hardscape', 'rev3.t': 'Muro y iluminación',
      ...
      'cta.step1.p': 'Un miembro real del equipo LAP recorre el lugar, escucha cómo quiere usar el espacio y toma medidas.',
      ...
      'ftr.flag': 'Prototipo — no es para producción.',
      'sticky.call': 'Llamar',
