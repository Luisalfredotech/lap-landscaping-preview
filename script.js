...
(function () {
  ...
  const dict = {
    en: {
      ...
      'svc.stone.p': 'Florida tumbled travertine pool decks, marble patios and natural stone walkways — mortar-set on proper base and sealed to handle heat, pool chemicals and heavy foot traffic.',
    ...
    es: {
      ...
      'svc.stone.p': 'Cubiertas de piscina en travertino floridano, patios de mármol y caminos de piedra natural — instalados con mortero y sellados para resistir calor, químicos y uso intenso.',
